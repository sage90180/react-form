...
const FormInput = ({className, label, type, name, content, value, onChange}) => (
    ...
    <FormWrap className="form_box"> 
      ...
      <FormMain className="form_main">
        ...
        <FormInput 
          ...
          onChange={handleInputChange} 
        />
        <label className="form_title necessary">報名類型<br/>
          <input 
            className="apply" 
            id="opt_1" 
            ...
            readOnly
          />
          <label className="apply" htmlFor="opt_1">躺在床上用想像力實作</label><br/>
          <input 
            className="apply" 
            id="opt_2" 
            type="radio" 
            ...
            readOnly
          />
          <label className="apply" htmlFor="opt_2">趴在地上滑手機找現成的</label>
        ...
        <FormInput 
          ...
          onChange={handleInputChange} 
        />
        <label className="form_title necessary">其它<br/>
          <textarea 
            value={data.others}
            rows="4" 
        ...
        <button type='submit' onClick={handleSubmit}>送 出</button>
